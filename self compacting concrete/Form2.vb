...
Handles MyBase.MouseMove
    ...
    Private Sub StartTheCalculationToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles StartTheCalculationToolStripMenuItem.Click
        If (Val(TextBox6.Text) + Val(TextBox10.Text) + Val(TextBox11.Text) + Val(TextBox12.Text)) = 100 And (Val(TextBox22.Text) + Val(TextBox23.Text)) = 100 Then
            ...
            End If
        Else
            MsgBox("make sure that the sun of powders is 100% and the sun of water01 and water02 % is 100%")
        End If
    ...
    Private Sub SaveAsTextFileToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SaveAsTextFileToolStripMenuItem.Click
        ...
        If results = DialogResult.OK Then
            ...
            file.WriteLine("Mix reference: " & TextBox1.Text)
            file.WriteLine(DateTime.Now)
            file.WriteLine("Mortar volume                   " & TextBox2.Text & " L")
            file.WriteLine("Sand/Mortar per Vol             " & (Val(TextBox3.Text) * 100) & " %")
            file.WriteLine("Water/Powder per Vol            " & TextBox4.Text)
            file.WriteLine("Superplasticizer per Vol        " & TextBox17.Text & " %")
            file.WriteLine("Superplasticizer Density        " & TextBox18.Text & " Kg/m3")
            file.WriteLine("Water content Superplasticizer  " & TextBox19.Text & " %")
            file.WriteLine("Density Sand                    " & TextBox20.Text & " Kg/m3")
            file.WriteLine("Sand water absorption           " & TextBox21.Text & " %")
            file.WriteLine("Water01                         " & TextBox22.Text & " %")
            file.WriteLine("Water02                         " & TextBox23.Text & " %")
            If ComboBox1.Text = "1" Then
                vol1po = (volume * per1po * pv) / 10000
                qua1po = (den1po * vol1po) / 1000
                quasup = (persup / 100) * (qua1po)
                ...
                quaw2 = (waterper2 / 100) * quawater
                waterpowderratio = volwater / (qua1po)
                file.WriteLine("name of powder" & "   " & "percentage %" & "     " & "Density Kg/m3")
                file.WriteLine(TextBox5.Text & "    " & TextBox6.Text & "                " & TextBox13.Text)
                file.WriteLine("                                 ")
                file.WriteLine("Results:")
                file.WriteLine("Volume per %")
                file.WriteLine("Powder Vol                      " & Label19.Text)
                file.WriteLine("Water Vol                       " & Label20.Text)
                file.WriteLine("Sand Vol                        " & Label23.Text)
                file.WriteLine("Volume per L")
                file.WriteLine("Sand                            " & Label36.Text)
                file.WriteLine("Water                           " & Label37.Text)
                file.WriteLine(Label25.Text & "                " & Label32.Text)
                file.WriteLine("Quantity per Kg")
                file.WriteLine("Sand                            " & Label39.Text)
                file.WriteLine("Total Water                     " & Label38.Text)
                file.WriteLine("Water01                         " & Label50.Text)
                file.WriteLine("Water02                         " & Label52.Text)
                file.WriteLine("Superplasticizer                " & Label54.Text)
                file.WriteLine("Water/Powder                    " & Label56.Text)
                file.WriteLine(Label49.Text & "                " & Label43.Text)
                file.WriteLine("                                 ")
                file.WriteLine("The quantity per 1m3:")
                file.WriteLine("Sand                            " & Math.Round(CType(quasand, Double), 3) & " Kg/m3")
                file.WriteLine("Total Water                     " & Math.Round(CType(quawater, Double), 3) & " Kg/m3")
                file.WriteLine("Water01                         " & Math.Round(CType(quaw1, Double), 3) & " Kg/m3")
                file.WriteLine("Water02                         " & Math.Round(CType(quaw2, Double), 3) & " Kg/m3")
                file.WriteLine("Superplasticizer                " & Math.Round(CType(quasup, Double), 3) & " Kg/m3")
    ...
    Private Sub SaveAsDocFileToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SaveAsDocFileToolStripMenuItem.Click
        ...
        If results = DialogResult.OK Then
            ...
            If ComboBox1.Text = "1" Then
                ...
                waterpowderratio = volwater / (qua1po)
                file.WriteLine("name of powder" & "   " & "percentage %" & "     " & "Density Kg/m3")
                file.WriteLine(Label25.Text & "    " & TextBox6.Text & "                " & TextBox13.Text)
                file.WriteLine("                                 ")
                file.WriteLine("Results:")
                file.WriteLine("Volume per %")
                file.WriteLine("Powder Vol                      " & Label19.Text)
            ...
            If ComboBox1.Text = "2" Then
                ...
                file.WriteLine("name of powder" & "   " & "percentage %" & "     " & "Density Kg/m3")
                file.WriteLine(Label25.Text & "    " & TextBox6.Text & "                " & TextBox13.Text)
                file.WriteLine(Label26.Text & "    " & TextBox10.Text & "                " & TextBox14.Text)
                file.WriteLine("                                 ")
                file.WriteLine("Results:")
                file.WriteLine("Volume per %")
                file.WriteLine("Powder Vol                      " & Label19.Text)
            ...
            If ComboBox1.Text = "3" Then
                ...
                file.WriteLine(Label25.Text & "    " & TextBox6.Text & "                " & TextBox13.Text)
                file.WriteLine(Label26.Text & "    " & TextBox10.Text & "                " & TextBox14.Text)
                file.WriteLine(Label27.Text & "    " & TextBox11.Text & "                " & TextBox15.Text)
                file.WriteLine("                                 ")
                file.WriteLine("Results:")
                file.WriteLine("Volume per %")
                file.WriteLine("Powder Vol                      " & Label19.Text)
            ...
            If ComboBox1.Text = "4" Then
                ...
                file.WriteLine(Label26.Text & "    " & TextBox10.Text & "                " & TextBox14.Text)
                file.WriteLine(Label27.Text & "    " & TextBox11.Text & "                " & TextBox15.Text)
                file.WriteLine(Label28.Text & "    " & TextBox12.Text & "                " & TextBox16.Text)
                file.WriteLine("                                 ")
                file.WriteLine("Results:")
                file.WriteLine("Volume per %")
                file.WriteLine("Powder Vol                      " & Label19.Text)
    ...
    Private Sub WaterContentInSpToolStripMenuItem_Click(sender As Object, e As EventArgs) 

    End Sub

    Private Sub CementRepacementToolStripMenuItem_Click(sender As Object, e As EventArgs) 

    End Sub

    Private Sub YesToolStripMenuItem_Click(sender As Object, e As EventArgs) 
